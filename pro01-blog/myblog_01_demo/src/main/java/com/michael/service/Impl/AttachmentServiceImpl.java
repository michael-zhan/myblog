...
import com.michael.mapper.AttachmentMapper;
import com.michael.pojo.Attachment;
import com.michael.service.AttachmentService;
import com.michael.util.ConfigManager;
...
/*
    ...
    public PageInfo<Attachment> pageAttachment(Integer pageIndex, Integer pageSize, HashMap<String, Object> criteria) {
        ...
        List<Attachment> attachmentList = attachmentMapper.findByOrigin(criteria);
        return new PageInfo<>(attachmentList, attachmentList.size());
    }
